...
function tejia()
{
	document.form1.method.value="tejia";
		form1.submit();
...
function top(){
   	form3.action="/zaixianbook_shop/admin/ptbook.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="/zaixianbook_shop/admin/ptbook.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="/zaixianbook_shop/admin/ptbook.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="/zaixianbook_shop/admin/ptbook.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="/zaixianbook_shop/admin/ptbook.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="/zaixianbook_shop/admin/ptbook.jsp?page="+page;
      form3.submit();
              ...
              <br>
                ...
                <table width="100%" cellspacing="0" cellpadding="0" border="1"  >
                  <tr>
                    ...
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">书名</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">作者</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">出版社</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">价格</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">分类</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">光盘</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">折率</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">推荐程度</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">库存</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">类型</td>
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">增加时间</td>   
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">修改</td>                
                    <td height="30" align="center" bordercolor="#669999" bgcolor="#99CCCC">选择</td>
                  </tr>
                  
                  <%   
                  	String sql="select count(*) from bookinformation  where book_type='普通'";
                  	String sql2="select * from bookinformation where book_type='普通' order by book_id desc";
				...
				<form name=form1 action="/zaixianbook_shop/BookManage.jsp" method=post>
						<input type="hidden" name="jsp" value="pt"> <input type="hidden" name="hidden3" value="haha"><input type="hidden" name="method" value="delbook">
				  <%
					    for(int i=0;i<list3.size();i++){
					        List list2 =(ArrayList)list3.get(i);System.out.println("list2="+list2);						       		     
					%>   
        				 <tr>
		                    <td  height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=i+1 %></td>
		                    <td  height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><a href="/zaixianbook_shop/admin/bookinfo.jsp?id=<%=list2.get(0).toString() %>" target="_blank"><%=list2.get(1).toString() %></a></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(2).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(3).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(4).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(5).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(6).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(7).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(8).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(9).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(10).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><%=list2.get(11).toString() %></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><a href="/zaixianbook_shop/admin/upbook.jsp?id=<%=list2.get(0).toString()%>&jsp=pt">修改</a></td>
		                  	<td height="30" align="center" bordercolor="#669999" bgcolor="#FFFFFF"><input type=checkbox name=choose   value=<%=list2.get(0).toString() %>></td>
		                  </tr>
				...
				<table>  <tr><td width="630" height="72"> 
                    ...
                    <td align="center" height="14" colspan="8" bordercolor="#5D8191" class="12txt18"><br>
                        <table align="center" width="550" cellpadding="0" cellspacing="0">
                          <tr>
                            ...
                            <input type="button" name="button3" value="设为特价" onClick="tejia()">&nbsp;&nbsp;&nbsp;
