...
function top(){
   	form3.action="/zaixianbook_shop/admin/news.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="/zaixianbook_shop/admin/news.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="/zaixianbook_shop/admin/news.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="/zaixianbook_shop/admin/news.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="/zaixianbook_shop/admin/news.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="/zaixianbook_shop/admin/news.jsp?page="+page;
      form3.submit();
              ...
              <br>
                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="center" bgcolor="#99CCCC" class="cd1">标题</td>
                  ...
                  <%   
                  	String sql="select count(*) from webnews ";
                  	String sql2="select * from webnews order by webnews_id desc";
			 		NewsPageBean pageutil = new NewsPageBean();  
				...
				<form name=form1 action="/zaixianbook_shop/News.jsp" method=post>
					...
					%>   
        				 <tr>
		                    ...
		                    <td height="30" align="center" bgcolor="#FFFFFF" class="cd1"><%=list2.get(1).toString() %></td>
		                  	...
		                  	<td align="center" bgcolor="#FFFFFF"  class="cd1"><a href="/zaixianbook_shop/admin/upnews.jsp?id=<%=list2.get(0).toString()%>">修改</a></td>
