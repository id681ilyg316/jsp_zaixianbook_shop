...
function del()
{
		document.form1.method.value="delcommont";
			form1.submit();
...
function top(){
   	form3.action="/zaixianbook_shop/admin/commont.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="/zaixianbook_shop/admin/commont.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="/zaixianbook_shop/admin/commont.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="/zaixianbook_shop/admin/commont.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="/zaixianbook_shop/admin/commont.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="/zaixianbook_shop/admin/commont.jsp?page="+page;
      form3.submit();
...
<table width="100%" height="100%" cellpadding="0" cellspacing="0">
  <tr>
    <td height="121" align="center" valign="top" bgcolor="#FFFFFF"><div align="left"><br>
            <span class="black14">　<strong>当前位置:</strong>评论管理</span><br>
    </div>
              ...
              <br>
                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="center" bgcolor="#99CCCC" class="cd1">内容</td>
                    <td align="center" bgcolor="#99CCCC" class="cd1">发布人</td>
                    <td align="center" bgcolor="#99CCCC" class="cd1">发布时间</td>
                    <td align="center" bgcolor="#99CCCC" class="cd1">评论书籍</td>
                    <td align="center" bgcolor="#99CCCC" class="cd1">选择</td>
                  </tr>
                  
                  <%   
                  	String sql="select count(*) from bookcomment ";
                  	String sql2="select * from bookcomment order by bookcomment_id desc";
			 		CommontPageBean pageutil = new CommontPageBean();  
				...
				<form name=form1 action="/zaixianbook_shop/CommontManage.jsp" method=post>
				<input type="hidden" name="method" value="delcommont"><input type="hidden" name="hidden3" value="haha">
				  <%
					...
					%>   
        				 <tr>
		                    ...
		                    <td height="30" align="center" bgcolor="#FFFFFF" class="cd1"><%=list2.get(1).toString() %></td>
		                  	...
		                  	<% String book_name=new OrderBean().getBookName(Integer.parseInt(list2.get(4).toString()));%>
		                  	<td align="center" bgcolor="#FFFFFF"  class="cd1"><a href="/zaixianbook_shop/admin/bookinfo.jsp?id=<%=list2.get(4).toString()%>" target="_blank"><%=book_name %></a></td>
		                  	<td align="center" bgcolor="#FFFFFF"  class="cd1"><input type=checkbox name=choose onClick="ra()"  value=<%=list2.get(0).toString() %>></td>
		                  </tr>
		                  
		   			 <%}%>
		  </form> 
  		<tr>
    	<td height="2" colspan="13" align="left" bordercolor="#5D8191" bgcolor="#5D8191"></td>
  		</tr>
  		
                <tr>
				<td height="2" colspan="13" align="right" bordercolor="#5D8191" >
    ...
    <input type="hidden" name="page" value="<%=session.getAttribute("busPage").toString()%>" /><!--//用于给上面javascript传值-->         
     ...
     第<input name="busjump" type="text" size="3" />页<a href="#" onClick="bjump()"><img src="/zaixianbook_shop/img/jump.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
       ...
       <tr>
                    <td align="center" height="13" colspan="8" bordercolor="#5D8191" class="12txt18"><br>
      ...
      <%}else{%>
		   			 <tr>
		                    <td colspan=13 align=center>当前没有信息！</td>
		                  </tr>
		   			 <%} %>
