...
function top(){
   	form3.action="/zaixianbook_shop/admin/newbook.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="/zaixianbook_shop/admin/newbook.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="/zaixianbook_shop/admin/newbook.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="/zaixianbook_shop/admin/newbook.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="/zaixianbook_shop/admin/newbook.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="/zaixianbook_shop/admin/newbook.jsp?page="+page;
      form3.submit();
            ...
            <TD align="center" bgColor=#ffffff><br>
              <br>
                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                  ...
                  <%   
                  	String sql="select count(*) from bookinformation  where book_type='最新'";
                  	String sql2="select * from bookinformation where book_type='最新' order by book_id desc";
					...
					%>   
        				 <tr>
		                    ...
		                    <td height="30" align="center" bgcolor="#FFFFFF" class="cd1"><a href="/zaixianbook_shop/admin/bookinfo.jsp?id=<%=list2.get(0).toString() %>" target="_blank"><%=list2.get(1).toString() %></a></td>
		                  	...
		                  	<td align="center" bgcolor="#FFFFFF"  class="cd1"><a href="/zaixianbook_shop/admin/upbook.jsp?id=<%=list2.get(0).toString()%>&jsp=new">修改</a></td>
