...
<%String name=(String)session.getAttribute("name");
	if(name==null){
		...
		List list=new UserLoginBean().getManager(Integer.parseInt(id));
 %>
<body >
            ...
            <TD align="center" bgColor=#ffffff><br>
              <br>
                    <table width="100%" cellpadding="0" cellspacing="0">
                        <tr>
                          <td width="100%" height="20" colspan="2" bgcolor="#009999"><p class="w14"> 　更改密码</p></td>
                        </tr>
                        <tr>
                          <td width="100%" height="100" align="center" bgColor=#FFFFFF><span class="hb"> <br>
                              ...
                              <table width="59%" cellpadding="0" cellspacing="0">
                                <tr>
                                  <td align="right" width="280" height="30">登录名:</td>
                                  <td width="205" ><%=list.get(1).toString() %></td>
                                </tr>
                                
                                <tr>
                                  <td align="right"  height="30">新密码（英文字母或数字6-16位，不能有空格）:</td>
