...
function del()
{
		document.form1.method.value="del2";
			form1.submit();
...
function top(){
   	form3.action="/zaixianbook_shop/admin/findingdan.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="/zaixianbook_shop/admin/findingdan.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="/zaixianbook_shop/admin/findingdan.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="/zaixianbook_shop/admin/findingdan.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="/zaixianbook_shop/admin/findingdan.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="/zaixianbook_shop/admin/findingdan.jsp?page="+page;
      form3.submit();
  ...
  <tr>
    <td height="121" align="center" valign="top" bgcolor="#FFFFFF"><div align="left"><br>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
            ...
            <TD align="center" bgColor=#ffffff><br>
              <br>
                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                  ...
                  <%   
                  	String sql="select count(*) from ordersendingform where ordersendingform_sendok='已经发货'";
                  	String sql2="select * from ordersendingform where ordersendingform_sendok='已经发货' order by ordersendingform_id desc";
  		...
  		<tr>
    	<td height="2" colspan="6" align="left" bordercolor="#5D8191" bgcolor="#5D8191"></td>
  		</tr>
  		
                <tr>
				<td height="2" colspan="6" align="right" bordercolor="#5D8191" >
    ...
    <input type="hidden" name="page" value="<%=session.getAttribute("busPage").toString()%>" /><!--//用于给上面javascript传值-->         
     ...
     第<input name="busjump" type="text" size="3" />页<a href="#" onClick="bjump()"><img src="/zaixianbook_shop/img/jump.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
       ...
       <tr>
                    <td align="center" height="6" colspan="8" bordercolor="#5D8191" class="12txt18"><br>
      ...
      <%}else{%>
		   			 <tr>
		                    <td colspan=6 align=center>当前没有信息！</td>
		                  </tr>
		   			 <%} %>
