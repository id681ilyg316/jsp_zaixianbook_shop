...
function fa()
{
	document.form1.method.value="fa";
		form1.submit();
...
function top(){
   	form3.action="/zaixianbook_shop/admin/newdingdan.jsp?page=1";
    form3.submit();
}
function last(){
	...
	form3.action="/zaixianbook_shop/admin/newdingdan.jsp?page="+form3.pageCount.value;
    	form3.submit();
	}
}
function pre(){
  ...
  if(page<=1){
    ...
    form3.action="/zaixianbook_shop/admin/newdingdan.jsp?page="+(page-1);
    form3.submit();
  }
}
...
function bjump(){
	...
	if(form3.busjump.value>pageCount){//如果跳转文本框中输入的页数超过最后一页的数，则跳到最后一页
	  ...
	  form3.submit();
		...
		form3.action="/zaixianbook_shop/admin/newdingdan.jsp?page="+pageCount;
		form3.submit();
	}
}
...
var page=parseInt(form3.busjump.value);
   if(page==0){
      ...
      form3.action="/zaixianbook_shop/admin/newdingdan.jsp?page="+page;
      form3.submit();
   }else{
      form3.action="/zaixianbook_shop/admin/newdingdan.jsp?page="+page;
      form3.submit();
  ...
  <tr>
    <td height="121" align="center" valign="top" bgcolor="#FFFFFF"><div align="left"><br>
        ...
        <table width="100%" cellpadding="0" cellspacing="0">
              ...
              <br>
                ...
                <table width="100%" cellspacing="0" cellpadding="0">
                  <tr>
                    ...
                    <td align="center" bgcolor="#99CCCC" class="cd1">订单号</td>
                    <td align="center" bgcolor="#99CCCC" class="cd1">用户</td>
                    <td align="center" bgcolor="#99CCCC" class="cd1">状态</td>
                    <td align="center" bgcolor="#99CCCC" class="cd1">付款方式</td>
                    <td align="center" bgcolor="#99CCCC" class="cd1">目前状态</td>
                    <td align="center" bgcolor="#99CCCC" class="cd1">选择</td>
                  </tr>
                  
                  <%   
                  	String sql="select count(*) from ordersendingform where ordersendingform_sendok='未发货'";
                  	String sql2="select * from ordersendingform where ordersendingform_sendok='未发货' order by ordersendingform_id desc";
			 		OrderPageBean pageutil = new OrderPageBean();  
				...
				<form name=form1 action="/zaixianbook_shop/Order.jsp" method=post>
						<input type="hidden" name="jsp" value="new"> <input type="hidden" name="hidden3" value="haha"><input type="hidden" name="method" value="delbook">
				  <%
					...
					%>   
        				 <tr>
		                    ...
		                    <td height="30" align="center" bgcolor="#FFFFFF" class="cd1"><a href="/zaixianbook_shop/admin/orderinfo.jsp?number=<%=list2.get(1).toString() %>" target="_blank"><%=list2.get(1).toString() %></a></td>
  		...
  		<tr>
    	<td height="2" colspan="7" align="left" bordercolor="#5D8191" bgcolor="#5D8191"></td>
  		</tr>
  		
                <tr>
				<td height="2" colspan="7" align="right" bordercolor="#5D8191" >
    ...
    <input type="hidden" name="page" value="<%=session.getAttribute("busPage").toString()%>" /><!--//用于给上面javascript传值-->         
     ...
     第<input name="busjump" type="text" size="3" />页<a href="#" onClick="bjump()"><img src="/zaixianbook_shop/img/jump.gif" border="0" /></a>&nbsp;&nbsp;&nbsp;
       ...
       <tr>
                    <td align="center" height="5" colspan="8" bordercolor="#5D8191" class="12txt18"><br>
                        <table align="center" width="550" cellpadding="0" cellspacing="0">
                          <tr>
                            <td align="center">
                            <input type="button" name="button3" value="发货" onClick="fa()">&nbsp;&nbsp;&nbsp;
      ...
      <%}else{%>
		   			 <tr>
		                    <td colspan=7 align=center>当前没有信息！</td>
		                  </tr>
		   			 <%} %>
