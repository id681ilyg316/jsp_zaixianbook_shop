...
function check()
{
	...
	<tr><input type=hidden name=method value=reg>
	<td align="center" colspan="2"><br><h2>用户注册</h2>以下项目必须填写</td>
	</tr>
	<tr>
	...
	<tr>
	<td align="center"  height="30">密码(6位)</td>
	<td align="left" ><input type="password" name="password" size="20" maxlength="16" value=<%=(String)request.getAttribute("password")==null?"":(String)request.getAttribute("password") %>></td>
	</tr>
	<tr>
	<td align="center" height="30">真实姓名</td>
	<td align="left" ><input type="text" name="name" size="20" maxlength="16" value=<%=(String)request.getAttribute("name")==null?"":(String)request.getAttribute("name") %>></td>
	</tr>
	<tr> 
	...
	<td align="left" ><input type="text" name="tel" size="20" maxlength="16" value=<%=(String)request.getAttribute("tel")==null?"":(String)request.getAttribute("tel") %>></td>
	</tr>
	<tr>
